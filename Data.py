...
def GetTrainingData():
    ...
    training_data.append({"class":"Vraag1", "sentence":"What is GDPR?"})

    training_data.append({"class":"Vraag2", "sentence":"When will the GDPR come into effect?"})

    training_data.append({"class":"Vraag3", "sentence":"Who does GDPR apply to?"})

    training_data.append({"class":"Vraag4", "sentence":"What responsibilities will companies have under this new regulation?"})

    training_data.append({"class":"Vraag5", "sentence":"What kind of information does the GDPR apply to?"})

    training_data.append({"class":"Vraag6", "sentence":"Are there any specific rules businesses should be following in order to ensure compliance?"})

    training_data.append({"class":"Vraag7", "sentence":"What will the penalties be for failing to comply with GDPR?"})

    training_data.append({"class":"Vraag8", "sentence":"What effect, if any, does Brexit have on GDPR?"})

    training_data.append({"class":"Vraag9", "sentence":"Do all organisations now have to appoint a Data Protection Officer (DPO)?"})

    training_data.append({"class":"Vraag10", "sentence":"What rights will individuals have under GDPR?"})
