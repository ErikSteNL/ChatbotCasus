...
def GetTrainingData():
    ...
    training_data.append({"class":"2", "sentence":"in what year will it come into effect start begin"})
    training_data.append({"class":"2", "sentence":"When will the new laws come into effect?"})
