...
zinnen = [
 ("Nederlands", "Hallo mijn naam is en ik vindt het leuk"),
 ("Nederlands", "en hebben bijna iedereen op school in de maling genomen"),
 ...
 ("Nederlands", "zit op zwemles."),
 ("Nederlands", "en ook kabouter."),
 ...
 ("Nederlands", "Eerst moet op zijn buik zwemmen."),
 ...
 ("Engels", "Hello my name is and I like it"),
 ("Engels", "and have almost scratched everyone at school"),
 ...
 ("Engels", "First, has to swim on his belly."),
 ("Engels", "He's already fine."),
 ("Engels", "But on his back, it's not possible yet."),
 ("Engels", "That's what he has to learn."),
 ("Engels", "Does the e work or does not matter?"),
 ("Duits", "Hallo mein Name ist und ich mag es"),
 ("Duits", "und haben fast alle in der Schule verkratzt"),
 ...
 ("Duits", "Erstens, muss auf seinem Bauch schwimmen."),
 ...
 ("Frans", "jour mon nom est et je l'aime"),
 ("Frans", "et ont presque egratigne tout le monde a l'ecole"),
 ...
 ("Frans", "Nous celebrons la fete, je mange un morceau de gateau, c'est ."),
 ("Frans", "Mon copain s'eloigne, demain ils partent, je suis tres heureux."),
 ("Frans", "est sur une lecon de natation."),
 ("Frans", "et aussi"),
 ...
 ("Frans", "Premierement, doit nager sur son ventre."),
 ...
 ("Zweeds", "Hej jag heter och jag gillar det"),
 ("Zweeds", "och har hasett alla pa skolan"),
 ...
 ("Zweeds", "Se upp!na pa trottoaren! Pa gatan ar det farligt."),
 ...
 ("Zweeds", "Forst maste simma pa magen."),
 ...
 ("Italiaans", "ciao il mio nome e e mi piace"),
 ("Italiaans", "e hanno quasi visto tutti a scuola"),
 ...
 ("Italiaans", "e in una lezione di nuoto"),
 ("Italiaans", "anche e "),
 ("Italiaans", "sono ai bordi della piscina"),
 ("Italiaans", " no aspettando il bagnino di Koen"),
 ("Italiaans", "se Koen e li, partiranno"),
 ("Italiaans", "saltano nel bagno profondo"),
 ("Italiaans", "prima, deve nuotare sullo stomaco"),
